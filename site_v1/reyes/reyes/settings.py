"""
Django settings for reyes project.
...
etc_dir = '/home/quinn/re_app_dev/etc/'
...
WSGI_APPLICATION = 'reyes.wsgi.application'
...
STATIC_URL = '/static/'
STATIC_ROOT=os.path.join(BASE_DIR, 'riogrande/static/') 
